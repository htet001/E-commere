...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <!-- Form Start -->
            <form action="/admin/product/<?php echo e($product->id); ?>/edit" method="post" enctype="multipart/form-data" class="table-bordered pb-5 px-5" style="background-image: url(<?php echo URL_ROOT . "assets/images/back1.png" ?>);background-size: cover;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" id="sub_cat_id" name="sub_cat_id">
                                ...
                                <option value="<?php echo e($cat->id); ?>" <?php echo $cat->id == $product->sub_cat_id ? 'selected' : '' ?>><?php echo e($cat->name); ?>
                ...
                <div class="form">
                    ...
                    <textarea class="form-control" id="description" name="description" style="height: 100px"><?php echo e($product->description); ?></textarea>
                </div>
